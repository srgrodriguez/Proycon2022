...
<head>
    ...
    <title>Trasladar maquinaria</title>
                    ...
                    <div id="idTrasladarMaquinaria">
                        <div class="panel panel-info" style=" width: auto">
                            ...
                            <div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="btnBuscarCodigo" class="btn btn-default" type="button" onclick="ConsultarEquipoTrasladar('codigo')"><img src="../resources/imagenes/icono_buscar.png" width="18px" alt="" /></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                  <?php CargarComboBoxTipoHerramienta('M', "cboTipoMaquinariaTraslado", "ConsultarEquipoTrasladar(\"tipo\")") ?>
                                </div>
                                <div class="col-lg-6">
                                <Select style="font-size: 15px" class="form-control" name="cboUbicacionTraslado" id="cboUbicacionTraslado" onchange="ConsultarEquipoTrasladar('ubicacion')" onclick="LimpiarComboTraslado1()">
