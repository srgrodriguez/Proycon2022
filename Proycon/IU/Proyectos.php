            ...
            <div class="panel-body">
                ...
                <div class="formularioMenuHerramientas">
                    <div class="formHerramientas">
                        ...
                        <div class="panel panel-info" id="pnlListarProyectos">
                            ...
                            <div class="panel-heading">
                                <h4><strong>Lista de Proyectos</strong></h4>
                            </div>
                            <div class="panel-body">
                                <?php if ($_SESSION['ID_ROL'] == 4 || $_SESSION['ID_ROL'] == 5) { ?>
                                    <!--Esta opcion solo es visible para el usuario de bodega -->
                ...
                <div class="informacionProyecto">
                    <article class="nombreProyecto">
                        ...
                        <?php if ($_SESSION['ID_ROL'] == 4 || $_SESSION['ID_ROL'] == 5) { ?>
                            <!-- Buestra los botones de opciones en proyctos-->
                    ...
                    <section class="pedidos" id="pedidos">
                        ...
                        <div class="panel panel-info" id="pnlListaPedidos">
                            ...
                            <div class="panel-heading">
                                <h4><strong id="tipolista">Lista de Pedidos</strong></h4>
                            </div>
                            <div class="panel-body">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form method="POST" id="frmRegistrarProyecto" name="frmInsertar" class="form-horizontal" action="">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2">Tipo Proyecto</label>
                                        <div class="col-lg-5">
                                            <div>
                                                <input type="checkbox" id="chkPorAdministracion" name="chkPorAdministracion">
                                                <label for="scales">Por Administración</label>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <?php if ($_SESSION['ID_ROL'] == 4 || $_SESSION['ID_ROL'] == 5) { ?>
                                    <!-- Esta opcion va hacer visile unicamente para el usuairo de bodega -->
